...
export const render = () => {
  ...
  tasks.forEach(t => {
    ...
    btnToggle.style.background = 'rgba(0, 73, 0, 1)';
    btnToggle.onmouseover = () => {
      btnToggle.style.background = 'rgba(0, 100, 0, 1)';
    };
    btnToggle.onmouseout = () => {
      btnToggle.style.background = 'rgba(0, 73, 0, 1)';
    };
    btnToggle.style.transition = 'background 0.3s ease, transform 0.2s ease';
    btnToggle.onclick = () => {
      toggleTask(t.id);
    ...
    btnDel.textContent = '✖';
    btnDel.style.background = 'rgb(106, 0, 0)';
    btnDel.style.transition = 'background 0.3s ease, transform 0.2s ease';
    btnDel.onmouseover = () => {
      btnDel.style.background = 'rgb(150, 0, 0)';
    };
    btnDel.onmouseout = () => {
      btnDel.style.background = 'rgb(106, 0, 0)';
    };
